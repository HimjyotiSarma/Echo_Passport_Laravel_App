...
class ConversationParticipantAdded implements ShouldBroadcast, ShouldDispatchAfterCommit
{
    ...
    public function broadcastWith(){
        return [
            'participant' => [
                'user' => $this->membership->user()->toResource(),
                'role' => $this->membership->role,
                'joined_at' => $this->membership->joined_at,
                'notification_enabled' => $this->membership->notification_enabled
            ]
        ];
    }
}
